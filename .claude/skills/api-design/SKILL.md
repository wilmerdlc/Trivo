...
---
_Importado desde [Aaronontheweb/dotnet-skills](https://github.com/Aaronontheweb/dotnet-skills) (MIT License), carpeta `skills/csharp-api-design`. Adaptar si entra en conflicto con `dotnet-endpoint-architecture` (mandato propio de Trivo, que tiene prioridad)._
